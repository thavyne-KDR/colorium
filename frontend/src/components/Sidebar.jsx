  ...
  return (
    <div style={{ 
      ...
      <div style={{ flexShrink: 0 }}> 
        ...
        {/* CONTAINER PERFIL + LOGOUT (Aqui está a mágica do alinhamento) */}
        <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between' }}>
            ...
            <div style={{ display: 'flex', alignItems: 'center', gap: '12px', overflow: 'hidden' }}>
                ...
                {/* Textos do Usuário, mudar aqui para o nome e email real */}
            ...
            >
              <img 
                    src="/sair.png" // O caminho da sua imagem na pasta public
                    alt="Sair"
                    style={{ 
                        width: '20px', // Ajuste o tamanho aqui se achar grande ou pequeno
                        height: '20px', 
                        display: 'block'
                    }} 
                />
